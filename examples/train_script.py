...
parser.add_argument('--algo', type=str, default='shac', choices=['shac', 'ppo', 'sac', 'bptt','shac_checkpoint_gd'])
...
for i in range(len(seeds)):
    ...
    elif args.algo == 'shac_checkpoint_gd':
        script_name = 'train_shac_checkpoint_gd.py'
